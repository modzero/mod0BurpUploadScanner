...
from burp import IHttpRequestResponse, IHttpService, IMessageEditorController
...
class ScanController(JSplitPane, IMessageEditorController, DocumentListener):
    ...
    def _create_ui(self):
        ...
        ui.OptionsPanel.OptionsPanel.mark_configured(self.lbl_upload_req_service)
    ...
    def insertUpdate(self, _):
        try:
            ...
            ui.OptionsPanel.OptionsPanel.mark_misconfigured(self.lbl_upload_req_service)
        if self.lbl_preflight_req_service.isVisible():
            try:
                ...
                ui.OptionsPanel.OptionsPanel.mark_configured(self.lbl_preflight_req_service)
            except Exception as e:
                ui.OptionsPanel.OptionsPanel.mark_misconfigured(self.lbl_preflight_req_service)
        if self.lbl_redownload_req_service.isVisible():
            try:
                ...
                ui.OptionsPanel.OptionsPanel.mark_configured(self.lbl_redownload_req_service)
            except Exception as e:
                ui.OptionsPanel.OptionsPanel.mark_misconfigured(self.lbl_redownload_req_service)
